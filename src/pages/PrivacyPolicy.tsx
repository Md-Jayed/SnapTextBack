          ...
          <div className="space-y-8 text-slate-600 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Name and phone number when you submit our demo request form on this website.</li>
                <li>If you voluntarily call our demo phone number after receiving form instructions, your call may be used to trigger the automated SMS demo experience you requested.</li>
              </ul>
            </section>

            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">2. How We Use Your Information</h2>
              <p className="mb-4">Your name and phone number are used to send you demo instructions and follow-up communications about SnapTextBack services. Your phone number is used only to deliver the automated SMS demo sequence you opted into by submitting the form.</p>
              <p>We do not use your information for any purpose beyond what is described here without your explicit consent.</p>
            </section>

            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">3. Demo Use Disclosure</h2>
              <p className="mb-4">SnapTextBack's SMS messaging functionality on this website is provided strictly for demonstration purposes. Messages are only sent when a user voluntarily calls our demo phone number to initiate the demo experience. This demo does not send unsolicited messages and does not represent live customer messaging activity.</p>
              <p className="mb-2">Example messages sent during the demo sequence:</p>
              <ul className="list-disc pl-6 space-y-2 italic">
                <li>"Hi, this is SnapTextBack! This is a demo showing how we respond to missed calls for local businesses."</li>
                <li>"Thanks for testing SnapTextBack — this is an automated response example. Reply YES to continue or STOP to end."</li>
                <li>"You're all set! A SnapTextBack rep will follow up with next steps."</li>
              </ul>
            </section>

            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">4. SMS / Text Messaging</h2>
              ...
              <p className="mb-4">After form submission, you will receive instructions directing you to call our demo phone number. Calling that number initiates the live demo SMS sequence. Continued participation constitutes your acceptance of additional automated messages in that sequence.</p>
            ...
            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">5. Email Communications</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">6. Data Sharing</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">7. Data Retention</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-bold text-slate-900">8. Cookies</h2>
